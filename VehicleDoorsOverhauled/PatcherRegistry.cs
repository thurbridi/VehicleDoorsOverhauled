...
namespace VehicleDoorsOverhauled
{
    static class PatcherRegistry {
        ...
        public static List<KeyValuePair<string, Func<VehiclePatcher>>> ModPatchers => 
        ...
        private static List<KeyValuePair<string, Func<VehiclePatcher>>> mscModPatchers = new List<KeyValuePair<string, Func<VehiclePatcher>>>()
        {
            // new("Saker", () => new ZSakerPatcher("Saker", () => GameObject.Find("SAKER(1350kg)").transform)),
        };
        ...
        private static readonly List<KeyValuePair<string, Func<VehiclePatcher>>> mwcModPatchers = new()
        {
